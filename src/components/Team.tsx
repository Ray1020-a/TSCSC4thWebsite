...
const MEMBERS: Member[] = [
  { name: 'LaiRay', role: '社長', avatar: '/team/ray.png', intro: '統籌社團整體事務。擅長睡覺熱愛說笑，只要是資訊類的都碰碰看，又不虧！', framed: true, sparkle: true, frame: '/team/frame/popcat.png' },  { name: 'Hailey', role: '副社長', avatar: '/team/hailey.jpg', intro: '協助社長處理社務、對外聯絡。一個特別的人，腦子很好什麼都會！', framed: true, sparkle: true, frame: '/team/frame/forhailey.png' },
